  ...
  return (
    <div className="min-h-screen flex w-full bg-background overflow-hidden relative">
        ...
        <div className="relative z-10 flex flex-col p-16 text-primary-foreground max-w-2xl h-full justify-between w-full">
          ...
          <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000">
            <div className="flex items-center gap-3 mb-12">
              <div className="w-14 h-14 bg-gradient-to-br from-white to-slate-200 rounded-2xl shadow-[0_0_40px_-10px_rgba(255,255,255,0.4)] flex items-center justify-center">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 relative overflow-y-auto z-10 bg-background/50 backdrop-blur-xl">
        ...
        <div className="w-full max-w-[420px] animate-in fade-in slide-in-from-right-8 duration-700 py-8">
          
          {/* Mobile Logo Fallback */}
          <div className="lg:hidden flex items-center gap-2 mb-10 justify-center">
            <div className="w-12 h-12 bg-primary rounded-xl shadow-lg flex items-center justify-center text-primary-foreground">
          ...
          <div className="text-center lg:text-left mb-8">
            <h2 className="text-4xl font-black tracking-tight text-foreground mb-3">Create Account</h2>
            <p className="text-lg text-muted-foreground font-medium">Join Cognify to intelligently manage your health.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <label htmlFor="name" className="text-sm font-bold text-foreground/80 uppercase tracking-wider">
                  Full Name
                </label>
              ...
              <div className="space-y-2">
                <label htmlFor="confirm-password" className="text-sm font-bold text-foreground/80 uppercase tracking-wider mt-2">
                  Confirm Password
                </label>
                <div className="relative group">
                  <Input
            ...
            <Button
              type="submit"
              className="w-full h-14 text-lg font-bold hover:scale-[1.02] transition-all duration-300 shadow-xl shadow-primary/20 group rounded-xl bg-primary hover:bg-primary/90 mt-6 relative overflow-hidden"
              disabled={isLoading}
            >
